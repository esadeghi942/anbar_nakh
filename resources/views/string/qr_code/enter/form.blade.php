<div class="row">
    <div class="form-group col-12 col-sm-6 col-md-2">
        <label for="day">{{__('panel.material')}}</label>
    ...
    <div class="form-group col-12 col-sm-6 col-md-2">
        <label for="day">{{__('panel.color')}}</label>
    ...
    <div class="form-group col-12 col-sm-6 col-md-1">
        <label for="day">{{__('panel.grade')}}</label>
    ...
    <div class="form-group col-12 col-sm-6 col-md-1">
        <label for="day">{{__('panel.layer')}}</label>
    ...
    <div class="form-group col-12 col-sm-6 col-md-3">
        <label for="day">{{__('panel.seller')}}</label>
    ...
    <div class="form-group col-12 col-sm-6 col-md-2">
        <label for="day">{{__('panel.lat')}}</label>
