...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row starter-main">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{route('anbar.store')}}">
                        @csrf
                        <div class="row">
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($anbars as $i => $anbar)
                                <tr>
                                    ...
                                    <td>{{ $anbar->name }}</td>
                                    <td>{{ $anbar->code }}</td>
                                    <td><a href="{{route('anbar.edit',$anbar)}}" class="btn"><i class="fa fa-edit"></i></a></td>
                                    <td>
                                        <form action="{{ route('anbar.destroy',$anbar->id)}}" method="POST">
                                            @method('DELETE')
                                            @csrf
